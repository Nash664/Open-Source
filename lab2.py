...
if weaponRoll <= 2:
    ...
    print("You rolled a strong weapon, good luck")

print("You rolled " + weapons[weaponRoll-1])
...
print( "Your " + weapons[weaponRoll-1] + " (" + str(combatStrength) + ") ---> Monster (" + str(mHealthPoints) + ")")
